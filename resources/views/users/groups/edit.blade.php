...
<div class="row">
	<div class="col-md-4">
		<div class="card">
			<div class="card-body">
				<h4 class="header-title">New Group</h4>
				<form action="{{ route('groups.update', $entity->id) }}" method="post">
					@csrf
					@method('PUT')
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label>Name</label>
								<input type="text" class="form-control" name="name" readonly="" value="{{ $entity->name }}">
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
